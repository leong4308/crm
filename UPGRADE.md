...
> [!NOTE]
> We strive to document every potential breaking change. However, as some of these alterations occur in lesser-known sections of Aether, only a fraction of them may impact your application.
...
Aether CRM v2.2 now requires PHP 8.3 or greater.

### Laravel 12 Upgrade

**Impact Probability: High**

Aether CRM v2.2 has been upgraded to Laravel 12, which introduces stricter type checking and modernized date/time handling.
