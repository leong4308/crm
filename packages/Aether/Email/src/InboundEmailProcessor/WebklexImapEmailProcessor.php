...
class WebklexImapEmailProcessor implements InboundEmailProcessor
{
    ...
    public function processMessage($message = null): void
    {
        ...
        /**
         * Asigna el nombre de la carpeta a la carpeta compatible en nuestra aplicación.
         *
         * Tareas pendientes: revisa esto.
         */
    ...
    /**
     * Procese los mensajes de todas las carpetas.
     *
    ...
    /**
     * Obtenga los correos electrónicos por el código de atributo.
     */
    ...
    /**
     * Convierta la fecha a la zona horaria deseada.
     *
