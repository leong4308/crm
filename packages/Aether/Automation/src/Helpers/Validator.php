...
{
    /**
     * Validar el flujo de trabajo para la condición
     *
    ...
    /**
     * Valor de retorno para el atributo
     *
     * @param  array  $condition
     * @param  mixed  $entity
     * @return bool
    ...
    /**
     * Validar valor de atributo para condición
     *
     * @param  array  $condition
    ...
    /**
     * Validar el valor de la condición contra una matriz multidimensional de forma recursiva
     */
