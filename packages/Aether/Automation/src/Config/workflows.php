...
return [
    'trigger_entities' => [
        ...
        'leads' => [
            'name' => 'Leads',
            'class' => 'Aether\Automation\Helpers\Entity\Lead',
            'events' => [
                [
        ...
        'activities' => [
            'name' => 'Activities',
            'class' => 'Aether\Automation\Helpers\Entity\Activity',
            'events' => [
                [
        ...
        'persons' => [
            'name' => 'Persons',
            'class' => 'Aether\Automation\Helpers\Entity\Person',
            'events' => [
                [
        ...
        'quotes' => [
            'name' => 'Quotes',
            'class' => 'Aether\Automation\Helpers\Entity\Quote',
            'events' => [
                [
