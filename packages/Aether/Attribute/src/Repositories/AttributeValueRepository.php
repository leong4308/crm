...
class AttributeValueRepository extends Repository
{
    ...
    public function isValueUnique($entityId, $entityType, $attribute, $value)
    {
        ...
        /**
         * Si el tipo de atributo es correo electrónico o teléfono, verifique el valor JSON.
         */
    ...
    /**
     * Se eliminaron los valores nulos de los campos de correo electrónico y teléfono.
     *
     * @param  array  $data
     * @return array
     */
