    ...
    'installer' => [
        'index' => [
            ...
            'installation-completed' => [
                ...
                'aether-forums' => 'Fórum do CRM v1',
                'customer-panel' => 'Painel do Cliente',
                'explore-aether-extensions' => 'Explorar Extensões do CRM v1',
                'title' => 'Instalação Concluída',
                'title-info' => 'O CRM v1 foi instalado com sucesso no seu sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'Criar as tabelas do banco de dados',
                'install' => 'Instalar',
                'install-info' => 'CRM v1 para Instalação',
            ...
            'back' => 'Voltar',
            'aether' => 'CRM v1',
            'aether-info' => 'um Projeto Comunitário por',
            'aether-logo' => 'Logotipo CRM v1',
            'continue' => 'Continuar',
            'installation-description' => 'A instalação do CRM v1 geralmente envolve várias etapas. Aqui está um resumo do processo de instalação do CRM v1.',
