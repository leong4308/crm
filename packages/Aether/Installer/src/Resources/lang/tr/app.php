    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'aether' => 'CRM v1 Kurulumu',
                'aether-info' => 'Veritabanı tabloları oluşturuluyor, bu birkaç dakika sürebilir',
                'title' => 'Kurulum',
            ],

            'installation-completed' => [
                'admin-panel' => 'Yönetici Paneli',
                'aether-forums' => 'CRM v1 Forumu',
                'customer-panel' => 'Müşteri Paneli',
                'explore-aether-extensions' => 'CRM v1 Uzantılarını Keşfedin',
                'title' => 'Kurulum Tamamlandı',
                'title-info' => 'CRM v1 sisteminize başarıyla kuruldu.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'Veritabanı tablosu oluştur',
                'install' => 'Yükleme',
                'install-info' => 'Kurulum için CRM v1',
            ...
            'start' => [
                ...
                'title' => 'CRM v1 kurulumunuz',
                'welcome-title' => 'CRM v1\'ya hoş geldiniz',
            ],
            ...
            'back' => 'Geri',
            'aether' => 'CRM v1',
            'aether-info' => 'Aether tarafından geliştirilen bir Topluluk Projesi',
            'aether-logo' => 'CRM v1 Logosu',
            'continue' => 'Devam Et',
            'installation-description' => 'CRM v1 kurulumu genellikle birkaç adım içerir. İşte CRM v1\'nun kurulum sürecine genel bir bakış',
            ...
            'title' => 'CRM v1 Kurulum Sihirbazı',
            'webkul' => 'Aether',
        ],
    ],
];
