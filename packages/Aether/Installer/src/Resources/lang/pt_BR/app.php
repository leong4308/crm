    ...
    'seeders' => [
        'attributes' => [
            'leads' => [
                ...
                'lead-value' => 'Valor Estimado do Lead',
    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'aether' => 'Instalação do CRM v1',
                'aether-info' => 'Criando as tabelas do banco de dados, isso pode levar alguns momentos',
                'title' => 'Instalação',
            ],

            'installation-completed' => [
                'admin-panel' => 'Painel de Administração',
                'aether-forums' => 'Fórum CRM v1',
                'customer-panel' => 'Painel do Cliente',
                'explore-aether-extensions' => 'Explorar Extensões CRM v1',
                'title' => 'Instalação Concluída',
                'title-info' => 'CRM v1 foi instalado com sucesso no seu sistema.',
            ],
            ...
            'start' => [
                ...
                'title' => 'Instalação do CRM v1',
                'welcome-title' => 'Bem-vindo ao CRM v1',
            ],
            ...
            'back' => 'Voltar',
            'aether' => 'CRM v1',
            'aether-info' => 'um projeto comunitário de',
            'aether-logo' => 'Logotipo CRM v1',
            'continue' => 'Continuar',
            'installation-description' => 'A instalação do CRM v1 geralmente envolve várias etapas. Aqui está uma visão geral do processo de instalação do CRM v1',
