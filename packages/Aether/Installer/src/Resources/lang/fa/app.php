    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'aether' => 'نصب کرایین',
                'aether-info' => 'در حال ایجاد جداول پایگاه داده، این ممکن است چند لحظه طول بکشد',
                'title' => 'نصب',
            ],

            'installation-completed' => [
                'admin-panel' => 'پنل مدیریت',
                'aether-forums' => 'انجمن کرایین',
                'customer-panel' => 'پنل مشتری',
                'explore-aether-extensions' => 'کاوش افزونه‌های کرایین',
                'title' => 'نصب کامل شد',
            ...
            'back' => 'بازگشت',
            'aether' => 'کرایین',
            'aether-info' => 'یک پروژه اجتماعی توسط',
            'aether-logo' => 'لوگوی کرایین',
            'continue' => 'ادامه',
