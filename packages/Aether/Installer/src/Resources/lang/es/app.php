    ...
    'seeders' => [
        'attributes' => [
            'leads' => [
                ...
                'lead-value' => 'Valor Estimado del Prospecto',
    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'aether' => 'Instalación de CRM v1',
                'aether-info' => 'Creando las tablas de la base de datos, esto puede tardar unos momentos',
                'title' => 'Instalación',
            ],

            'installation-completed' => [
                'admin-panel' => 'Panel de Administración',
                'aether-forums' => 'Foro de CRM v1',
                'customer-panel' => 'Panel de Clientes',
                'explore-aether-extensions' => 'Explorar Extensiones de CRM v1',
                'title' => 'Instalación Completada',
                'title-info' => 'CRM v1 se ha instalado correctamente en su sistema.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'Crear tabla de base de datos',
                'install' => 'Instalación',
                'install-info' => 'CRM v1 Para la Instalación',
            ...
            'start' => [
                ...
                'title' => 'Instalación de CRM v1',
                'welcome-title' => 'Bienvenido a CRM v1',
            ],
            ...
            'back' => 'Atrás',
            'aether' => 'CRM v1',
            'aether-info' => 'un Proyecto Comunitario de',
            'aether-logo' => 'Logotipo de CRM v1',
            'continue' => 'Continuar',
            'installation-description' => 'La instalación de CRM v1 generalmente implica varios pasos. Aquí hay un esquema general del proceso de instalación de CRM v1.',
