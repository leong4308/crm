    ...
    'installer' => [
        'index' => [
            ...
            'installation-processing' => [
                'aether' => 'تثبيت CRM v1',
                'aether-info' => 'إنشاء جداول قاعدة البيانات، وقد يستغرق ذلك بضع دقائق',
                'title' => 'التثبيت',
            ],

            'installation-completed' => [
                'admin-panel' => 'لوحة المشرف',
                'aether-forums' => 'منتديات CRM v1',
                'customer-panel' => 'لوحة العميل',
                'explore-aether-extensions' => 'استكشاف امتدادات CRM v1',
                'title' => 'اكتمال التثبيت',
                'title-info' => 'تم تثبيت CRM v1 بنجاح على نظامك.',
            ],

            'ready-for-installation' => [
                'create-databsae-table' => 'إنشاء جدول قاعدة البيانات',
                'install' => 'التثبيت',
                'install-info' => 'CRM v1 للتثبيت',
            ...
            'start' => [
                ...
                'title' => 'تثبيت CRM v1 الخاص بك',
                'welcome-title' => 'مرحبًا بك في CRM v1',
            ],
            ...
            'back' => 'رجوع',
            'aether' => 'CRM v1',
            'aether-info' => 'مشروع مجتمعي من قبل',
            'aether-logo' => 'شعار CRM v1',
            'continue' => 'متابعة',
            'installation-description' => 'عادة ما تتضمن عملية تثبيت CRM v1 عدة خطوات. إليك نظرة عامة عامة على عملية التثبيت aether',
