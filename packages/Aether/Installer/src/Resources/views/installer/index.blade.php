        ...
        @pushOnce('scripts')
            ...
            >
                ...
                <div class="flex flex-col justify-center">
                    <div class="m-auto grid h-[100vh] max-w-[362px] items-end">
                        <div class="grid gap-4">
                            <img
                                src="{{ vite()->asset('images/aether-logo.svg', 'installer') }}"
                                alt="@lang('installer::app.installer.index.aether-logo')"
                            >
                        ...
                        <p class="mb-6 w-full place-self-end text-left">
                            <a
                                ...
                                href="https://aethercrm.com/"
                            >
                                @lang('installer::app.installer.index.aether')
                            </a>

                            <span>@lang('installer::app.installer.index.aether-info')</span>
                    ...
                    <div class="flex h-[484px] flex-col justify-center gap-4 overflow-y-auto px-7 py-4">
                        <div class="flex flex-col gap-4">
                            <p class="text-lg font-bold text-gray-800">
                                @lang('installer::app.installer.index.installation-processing.aether')
                            </p>
                            ...
                            <div class="grid gap-2.5">
                                ...
                                <p class="text-sm text-gray-600">
                                    @lang('installer::app.installer.index.installation-processing.aether-info')
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        type="text"
                                        name="app_name"
                                        ::value="envData.app_name ?? 'CRM v1'"
                                        rules="required"
                                        :label="trans('installer::app.installer.index.environment-configuration.application-name')"
                                        :placeholder="trans('installer::app.installer.index.environment-configuration.aether')"
                                    />
                            ...
                            <div class="flex h-[484px] flex-col gap-3 overflow-y-auto border-b border-gray-300 px-7 py-4">
                                ...
                                <x-installer::form.control-group class="mb-2.5">
                                    ...
                                    <x-installer::form.control-group.control
                                        ...
                                        :placeholder="trans('installer::app.installer.index.create-administrator.aether')"
                                    />
                ...
                >
                    ...
                    <div class="flex items-center justify-between px-4 py-2.5">
                        <a
                            href="https://forums.aethercrm.com/"
                            class="cursor-pointer text-xs font-semibold text-brandColor"
                        >
                            @lang('installer::app.installer.index.installation-completed.aether-forums')
                        </a>

                        <a
                            href="https://aethercrm.com/extensions/"
                            class="cursor-pointer rounded-md border border-brandColor bg-white px-3 py-1.5 font-semibold text-brandColor hover:opacity-90"
                        >
                            @lang('installer::app.installer.index.installation-completed.explore-aether-extensions')
                        </a>
                    </div>
                </div>
            </script>
                            ...
                            const stepActions = {
                                envDatabase: () => {
                                    if (params.db_connection === 'mysql') {
                                        ...
                                        setErrors({ 'db_connection': ["CRM v1 currently supports MySQL only."] });
                                    }
                                },
