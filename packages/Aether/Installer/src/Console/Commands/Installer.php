...
class Installer extends Command
{
     ...
     * @var string
     */
    protected $signature = 'aether-crm:install
     ...
     * @var string
     */
    protected $description = 'aether installer.';
    ...
    public function handle()
    {
        ...
        $this->warn('Step: Seeding basic data for CRM v1 kickstart...');
        $this->info(app(CRMV1DatabaseSeeder::class)->run([
    ...
    /**
     *  Comprobando el archivo .env y, si no lo encuentra, cree el archivo .env
     *
     * @return ?array
     */
    ...
    /**
     * Cree un nuevo archivo .env. Luego, solicite los detalles de configuración del entorno y configúrelos.
     * en el archivo .env para facilitar la migración a nuestra base de datos.
     *
     * @return ?array
     */
    ...
    /**
     * Solicite detalles de la solicitud.
     *
     * @return void
     */
    ...
    /**
     * Agregue las credenciales de la base de datos al archivo .env.
     */
    ...
    /**
     * Cree credenciales de administrador.
     *
     * @return mixed
     */
    protected function createAdminCredentials()
    {
        ...
        try {
            ...
            File::put($filePath, 'CRM v1 is successfully installed');

            $this->info('-----------------------------');
            $this->info('Congratulations!');
            $this->info('The installation has been finished and you can now use CRM v1.');
    ...
    /**
     * Variables Env cargadas para archivos de configuración.
     */
    ...
    /**
     * Método para solicitar los detalles de los archivos .env
     */
    ...
    /**
     * Método para pedir elección basado en la lista de opciones.
     *
     * @return string
     */
    ...
    /**
     * Verifique la clave en el archivo `.env` porque ayudará a encontrar valores en tiempo de ejecución.
     */
