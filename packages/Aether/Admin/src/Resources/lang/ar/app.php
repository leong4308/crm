...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Powered by :aether, an open-source project by :webkul.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'البحث الشامل',
    ...
    'leads' => [
        ...
        'view' => [
            ...
            'quotes' => [
                ...
                'add-btn' => 'إضافة عرض',
                'mail' => 'البريد',
                'quote-not-found' => 'لم يتم العثور على العرض لهذه الفرصة.',
                'person-email-unavailable' => 'بريد الشخص المرتبط بهذه الفرصة غير متوفر.',
                'mail-subject' => 'عرض سعر: :subject',
                'mail-body' => 'يرجى العثور على ملف عرض السعر PDF المرفق. تم إنشاء البريد بواسطة النظام.',
                'mail-send-failed' => 'تعذر إرسال بريد عرض السعر.',
            ],
            'products' => [
                'product-name' => 'اسم المنتج',
                'quantity' => 'الكمية',
            ...
            'general' => [
                ...
                'general' => [
                    ...
                    'admin-logo' => [
                        ...
                        'favicon-image-info' => 'تكوين صورة Favicon للوحة الإدارة الخاصة بك.',
                    ],
                ],
                'settings' => [
                    'title' => 'الإعدادات',
                    ...
                    'footer' => [
                        'info' => 'يمكننا تكوين قسم "Powered by" هنا.',
                        'powered-by' => 'محرر نص "Powered by"',
                        'title' => 'تكوينات قسم "Powered by"',
                    ],
                    'menu' => [
                        'activities' => 'الأنشطة',
