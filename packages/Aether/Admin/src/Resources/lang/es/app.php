...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desarrollado por :aether CRM v1.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Búsqueda Mega',
        ...
        'users' => [
            'index' => [
                ...
                'create' => [
                    ...
                    'select-at-lest-one-group' => 'Selecciona al menos un grupo',
                    'create-new-role' => '¿Crear nuevo rol para este usuario?',
                ],
                'edit' => [
        ...
        'index' => [
            ...
            'kanban' => [
                ...
                'stages' => [
                    'won'            => 'Ganado',
                    'lost'           => 'Perdido',
                    'need-more-info' => 'Se necesitan más detalles',
    ...
    'layouts' => [
        ...
        'lead' => 'Prospecto',
        'lead-info' => 'Administra todas las configuraciones relacionadas con los prospectos en el CRM',
        'quick-add' => [
            'title' => 'Añadir rápido',
            'save' => 'Guardar',
            'to' => 'Para',
        ...
        'pipelines-info' => 'Agregar, editar o eliminar embudos de venta del CRM',
        'sources' => 'Fuentes',
        ...
        'webhooks' => 'Notificaciones Web',
        'webhooks-info' => 'Agregar, editar o eliminar notificaciones web del CRM',
        'other-settings' => 'Otras Configuraciones',
    ...
    'whatsapp' => [
        'send-success' => 'Mensaje de WhatsApp enviado correctamente.',
    ],
];
