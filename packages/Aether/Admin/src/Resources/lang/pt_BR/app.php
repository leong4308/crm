...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Desenvolvido por :aether, um projeto de código aberto da :webkul.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Busca rápida',
    ...
    'leads' => [
        ...
        'view' => [
            ...
            'quotes' => [
                ...
                'mail' => 'Email',
                'quote-not-found' => 'Cotação não encontrada para este lead.',
                'person-email-unavailable' => 'O e-mail da pessoa do lead não está disponível.',
                'mail-subject' => 'Cotação: :subject',
                'mail-body' => 'Please find the attached quote PDF. Mail Generated by System.',
                'mail-send-failed' => 'Não foi possível enviar o e-mail da cotação.',
            ],
            'products' => [
                'product-name' => 'Nome do Produto',
                'quantity' => 'Quantidade',
            ...
            'general' => [
                ...
                'general' => [
                    ...
                    'admin-logo' => [
                        ...
                        'favicon-image-info' => 'Configure a imagem do favicon para o seu painel de administração.',
                    ],
                ],
                'settings' => [
                    'title' => 'Configurações',
