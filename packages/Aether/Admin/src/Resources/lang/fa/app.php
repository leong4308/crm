...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'توسعه یافته توسط :aether، یک پروژه متن باز از :webkul.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'جستجوی بزرگ',
    ...
    'leads' => [
        ...
        'view' => [
            ...
            'quotes' => [
                ...
                'mail' => 'ایمیل',
                'quote-not-found' => 'پیشنهادی برای این سرنخ یافت نشد.',
                'person-email-unavailable' => 'ایمیل شخص این سرنخ در دسترس نیست.',
                'mail-subject' => 'پیشنهاد: :subject',
                'mail-body' => 'لطفا فایل PDF پیشنهاد پیوست شده را مشاهده کنید. ایمیل توسط سیستم ایجاد شده است.',
                'mail-send-failed' => 'ارسال ایمیل پیشنهاد امکان‌پذیر نیست.',
            ],
            'products' => [
                'product-name' => 'نام محصول',
                'quantity' => 'تعداد',
