...
return [
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'Được hỗ trợ bởi :aether, một dự án mã nguồn mở được phát triển bởi :webkul.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'Tìm kiếm Mega',
            ...
            'general' => [
                ...
                'general' => [
                    ...
                    'admin-logo' => [
                        ...
                        'favicon-image' => 'Hình ảnh Favicon',
                        'favicon-image-info' => 'Cấu hình hình ảnh favicon cho bảng điều khiển quản trị của bạn.',
                    ],
                ],
                'settings' => [
                    'title' => 'Cài đặt',
