...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-inline-address-edit', {
            ...
            computed: {
                /**
                 * Obtenga las reglas de validación.
                 * 
                 * @return {Object}
                 */
                getValidation() {
            ...
            methods: {
                ...
                haveStates() {
                    /*
                    * El operador de doble negación se utiliza para convertir el valor a booleano.
                    * Asegura que el resultado final sea un valor booleano,
                    * Es verdadero si la matriz tiene una longitud mayor que 0 y, en caso contrario, es falso.
                    */
