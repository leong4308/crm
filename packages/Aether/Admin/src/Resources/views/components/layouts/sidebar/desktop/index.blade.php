<div
    ref="sidebar"
    class="duration-80 fixed top-[60px] z-[10002] h-full w-[200px] border-gray-300 bg-white dark:bg-gray-900 pt-4 transition-all group-[.sidebar-collapsed]/container:w-[70px] dark:border-gray-800 max-lg:hidden ltr:border-r rtl:border-l"
