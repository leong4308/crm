<header class="sticky top-0 z-[10001] flex items-center justify-between gap-1 border-b border-gray-300 bg-white dark:bg-gray-900 px-4 py-2.5 transition-all dark:border-gray-800">  
    <!-- logo -->
