...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-lookup', {
            ...
            computed: {
                /**
                 * Filtre los resultados buscados según la consulta de búsqueda.
                 *
                 * @return {Array}
                 */
                filteredResults() {
            ...
            methods: {
                ...
                /**
                 * Se activa al pulsar una tecla: carga los valores predeterminados cuando está vacío, busca cuando se escribe.
                 *
                 * @return {void}
                 */
                search() {
