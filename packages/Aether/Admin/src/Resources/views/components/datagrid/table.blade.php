...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-datagrid-table', {
            ...
            methods: {
                /**
                 * Seleccione todos los registros en la cuadrícula de datos.
                 *
                 * @returns {void}
                 */
                selectAll() {
                ...
                /**
                 * Realice una operación de clasificación en la columna especificada.
                 *
                 * @param {object} column
                 * @returns {void}
                 */
                ...
                /**
                 * Realice la acción especificada.
                 *
                 * @param {object} action
                 * @returns {void}
                 */
