...
@pushOnce('scripts')
    ...
    <script type="module">
        app.component('v-datagrid-export', {
            ...
            methods: {
                /**
                 * Registra eventos para actualizar propiedades y desencadenar el proceso de descarga.
                 *
                 * @returns {void}
                 */
                registerEvents() {
                ...
                /**
                 * Actualiza las propiedades disponibles y aplicadas con nuevos valores.
                 *
                ...
                /**
                 * Inicia el proceso de descarga para exportar datos.
                 *
                 * @returns {void}
                 */
                download() {
                    if (! this.available?.records?.length) {
                        ...
                        this.$axios
                            ...
                            .then((response) => {
                                ...
                                /**
                                 * Agregar un enlace a un documento, hacer clic en el enlace y luego eliminarlo.
                                 */
