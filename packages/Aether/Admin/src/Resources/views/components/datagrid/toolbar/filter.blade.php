    ...
    <script type="module">
        app.component('v-datagrid-filter', {
            ...
            methods: {
                ...
                /**
                 * Elimine todos los filtros aplicados.
                 *
                 * @returns {void}
                 */
                ...
                /**
                 * Elimine la opción de filtro de la pantalla para guardar filtros.
                 *
                 * @returns {void}
                 */
                ...
                /**
                 * Aplicar todos los filtros agregados.
                 *
                 * @returns {void}
                 */
                applyFilters() {
                ...
                addFilter($event, column = null, additional = {}) {
                    ...
                    if (quickFilter?.isActive) {
                        ...
                        /**
                         * Aquí vendrá un evento real o un valor de cadena. Si hay un valor de cadena presente, entonces
                         * Creamos una estructura similar a un evento para evitar roturas y facilitar su uso.
                         */
                ...
                /**
                 * Compruebe si se aplica algún valor para la columna especificada.
                 *
                 * @param {object} column
                 * @returns {boolean}
                 */
                ...
                /**
                 * Obtiene los valores aplicados para la columna especificada.
                 *
                 * @param {string} columnIndex
                 * @returns {Array}
                 */
                ...
                /**
                 * Elimina un valor específico de los valores aplicados de la columna especificada.
                 *
                 * @param {string} columnIndex
                ...
                removeAppliedColumnValue(columnIndex, appliedColumnValue) {
                    ...
                    /**
                     * La limpieza se hace aquí. Si no hay valores aplicados presentes, no tiene sentido incluir también la columna aplicada.
                     */
                    if (! appliedColumn.value.length) {
                ...
                /**
                 * Elimine todos los valores de los valores aplicados de la columna especificada.
                 *
                 * @param {string} columnIndex
                 * @returns {void}
                 */
