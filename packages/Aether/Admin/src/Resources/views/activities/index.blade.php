    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-calendar', {
                ...
                mounted() {
                    /**
                     * Escuche el evento de cambio de tema.
                     *
                     * @return {void}
                     */
                ...
                methods: {
                    /**
                     * Obtén las actividades para el calendario.
                     *
                    ...
                    /**
                     * Procesar eventos para mejorar su visualización.
                     *
                     * @param {Array} events
                     * @return {Array}
                     */
                    ...
                    /**
                     * Función hash de cadena simple para una generación de color consistente
                     *
                     * @param {string} str
                     * @return {number}
                     */
                    ...
                    /**
                     * Dar formato a la hora para mostrarla en la plantilla de evento
                     *
                     * @param {object} date
                     * @return {string}
                     */
                    ...
                    /**
                     * Redirigir a la página de edición de actividad.
                     *
                     * @param {Object} event
                     * @return {void}
                     */
        ...
        <script>
            /**
             * Actualizar el estado de `is_done`.
             *
             * @param {Event} {target}
             * @return {void}
             */
