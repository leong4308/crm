                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        @foreach ($lead->person->emails as $email)
                            <div class="flex gap-1">
                                ...
                                <span class="text-gray-500 dark:text-gray-300">
                                    ({{ trans()->has('admin::app.common.custom-attributes.' . $email['label']) ? trans('admin::app.common.custom-attributes.' . $email['label']) : $email['label'] }})
                                </span>
                            </div>
                        @endforeach
                        ...
                        @foreach ($lead->person->contact_numbers as $contactNumber)
                            <div class="flex gap-1">
                                ...
                                <span class="text-gray-500 dark:text-gray-300">
                                    ({{ trans()->has('admin::app.common.custom-attributes.' . $contactNumber['label']) ? trans('admin::app.common.custom-attributes.' . $contactNumber['label']) : $contactNumber['label'] }})
                                </span>
                            </div>
                        @endforeach
