                ...
                <div class="flex flex-col gap-4 px-4 py-2">
                    ...
                    >
                        ...
                        <div class="w-1/2 max-md:w-full">
                            <x-admin::attributes
                                :custom-attributes="app('Aether\Attribute\Repositories\AttributeRepository')->findWhere([
                                    'entity_type' => 'quotes',
                                    ['code', 'IN', ['subject']],
                                ])"
                                :custom-validations="[
        ...
        <script type="module">
            ...
            app.component('v-quote-item-list', {
                ...
                computed: {
                    ...
                    /**
                     * Calcular el importe total del descuento de los productos.
                     *
                     * @returns {Number}
                     */
                    discountAmount() {
                    ...
                    /**
                     * Calcule el monto total del impuesto de los productos.
                     *
                     * @returns {Number}
                     */
                    taxAmount() {
                    ...
                    /**
                     * Calcule el total general de los productos.
                     *
                     * @returns {Number}
                     */
                    grandTotal() {
                ...
                methods: {
                    /**
                     * Analice valores similares a decimales de forma segura.
                     *
                    ...
                    /**
                     * Formatee los valores numéricos como decimales fijos.
                     *
                     * @param {Number|String|null} value
                     *
                     * @returns {String}
                    ...
                    /**
                     * Calcular el subtotal de la línea de productos.
                     *
                    ...
                    /**
                     * Mantenga el importe del ajuste almacenado como una cadena decimal fija.
                     *
                     * @param {Object} event
                     *
                     * @returns {void}
                    ...
                    /**
                     * Busque y reemplace artículos con productos principales seleccionados.
                     *
            ...
            app.component('v-quote-item', {
                ...
                computed: {
                    /**
                     * Obtenga el nombre de la entrada.
                     *
                     * @returns {String}
                     */
                    inputName() {
