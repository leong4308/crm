    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-workflow', {
                ...
                data() {
                    return {
                        events: @json(app('\Aether\Automation\Helpers\Entity')->getEvents()),
        ...
        <script type="module">
            app.component('v-workflow-condition-item', {
                ...
                data() {
                    return {
                        conditions: @json(app('\Aether\Automation\Helpers\Entity')->getConditions()),
                ...
                computed: {
                    /**
                     * Obtenga el atributo coincidente.
                     *
                     * @returns {Object}
                     */
        ...
        <script type="module">
            app.component('v-workflow-action-item', {
                ...
                data() {
                    return {
                        actions: @json(app('\Aether\Automation\Helpers\Entity')->getActions()),
                    };
                },

                computed: {
                    /**
                     * Obtenga la acción coincidente.
                     *
                     * @returns {Object}
                     */
                    matchedAction () {
