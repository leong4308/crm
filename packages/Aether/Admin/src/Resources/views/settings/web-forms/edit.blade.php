    ...
    @pushOnce('scripts')
        ...
        <script type="module">
            app.component('v-webform', {
                ...
                watch: {
                    /**
                     * Esté atento al valor createLead y elimine los atributos agregados si el valor es verdadero.
                     *
                ...
                computed:{
                    /**
                     * Obtenga el valor del marcador de posición según el valor de la acción de envío exitoso.
                     *
                     * @return {String}
                     */
                    placeholder() {
                    ...
                    /**
                     * Obtenga los atributos agrupados según el tipo de entidad.
                     *
                     * @return {Object}
                     */
                    groupedAttributes() {
                ...
                methods: {
                    /**
                     * Actualice el valor createLead desde el modificador create_lead.
                     *
                     * @param {Event} event
                     * @return {void}
                     */
                    ...
                    /**
                     * Copie el valor al portapapeles.
                     *
                     * @param {String} ref
                     * @param {String} btn
                     *
                    ...
                    /**
                     * Agregue el atributo a la lista de atributos agregados.
                     *
                    ...
                    /**
                     * Elimine el atributo de la lista de atributos agregados.
                     *
                     * @param {Object} attribute
                     *
                     * @return {void}
                    ...
                    /**
                     * Obtenga el valor del marcador de posición según el tipo de atributo.
                     *
                     * @param {Object} attribute
                     *
                     * @return {String}
