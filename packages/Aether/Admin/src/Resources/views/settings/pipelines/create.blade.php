<x-admin::layouts>
    ...
    >
        ...
        <div class="flex gap-2.5 overflow-auto py-3.5 max-xl:flex-wrap">
            ...
            <v-pipeline-editor-create></v-pipeline-editor-create>
    ...
    @pushOnce('scripts')
        <script
            ...
            id="v-pipeline-editor-create-template"
        >
        ...
        <script type="module">
            app.component('v-pipeline-editor-create', {
                        template: '#v-pipeline-editor-create-template',
