@php($placeholders = app('\Aether\Automation\Helpers\Entity')->getEmailTemplatePlaceholders())
    ...
    @pushOnce('scripts')
                    ...
                    <div class="box-shadow rounded-lg border border-gray-300 bg-white p-4 dark:border-gray-800 dark:bg-gray-900">
                        ...
                        <div class="flex flex-col gap-4">
                            <div>
                                ...
                                <!-- URL Preview -->
                                <div class="flex w-full items-center justify-between rounded-sm border border-gray-300 bg-white px-4 py-2 text-sm dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300">
                            ...
                            <!-- Headers -->
                            <div class="border-y border-gray-300 dark:border-gray-800">
                                <v-key-and-value
                    ...
                    <x-admin::accordion>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group>
                                ...
                                >
                                    @foreach (app('\Aether\Automation\Helpers\Entity')->getEvents() as $item)
        ...
        <script type="module">
            app.component('v-webhooks', {
                ...
                watch: {
                    /**
                     * Mire el tipo sin formato y actualice tempPayload.
                     *
                     * @return {void}
                     */
                    ...
                    /**
                     * Observe el tipo de contenido y actualice tempPayload.
                     *
                     * @return {void}
                     */
                ...
                computed: {
                    /**
                     * Compruebe si se debe mostrar el editor.
                     * @returns {boolean}
                     */
                    showEditor() {
                        return (
                ...
                methods: {
                    /**
                     * Manejar la visualización del editor.
                     *
                     * @returns {void}
                     */
                    handleEditorDisplay() {
                    ...
                    /**
                     * Obtenga el punto final de la URL con los parámetros
                     *
                     * @returns {string}
                     */
                    urlEndPoint() {
            ...
            app.component('v-key-and-value', {
                ...
                methods: {
                    ...
                    /**
                     * Guarde la posición del cursor cuando la entrada esté enfocada.
                     *
                     * @param {Event} event
                     * @returns {void}
                     */
                    ...
                    /**
                     * Inserte el marcador de posición seleccionado en el asunto.
                     *
                     * @returns {void}
                     */
