    ...
    [
        ...
        'fields' => [
            [
                ...
                'type' => 'select',
                'default' => 'en',
                'options' => 'Aether\Core\Core@locales',
            ],
        ],
    ], [
        ...
        'fields' => [
            [
                ...
                'type' => 'editor',
                'default' => 'Powered by <span style="color: rgb(141, 163, 153);"><a href="http://localhost">Aether</a></span>.',
                'tinymce' => true,
            ],
        ],
    ], [
