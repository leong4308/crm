...
class ImportController extends Controller
{
    ...
    /**
     * Mostrar el formulario para editar un nuevo recurso.
     */
    ...
    public function start(int $id): JsonResponse
    {
        ...
        /**
         * Establecer el estado de importación en procesamiento
         */
        ...
        /**
         * Obtenga el primer lote pendiente para importar
         */
    ...
    public function link(int $id): JsonResponse
    {
        ...
        /**
         * Establecer el estado de importación para vincular
         */
        ...
        /**
         * Obtenga el primer lote de procesamiento para vincular
         */
        $importBatch = $import->batches->where('state', Import::STATE_PROCESSED)->first();

        /**
         * Establecer el estado de importación en vinculado/completado
         */
        if ($importBatch) {
            /**
             * Iniciar el proceso de vinculación de recursos
             */
            try {
    ...
    public function indexData(int $id): JsonResponse
    {
        ...
        if ($importBatch) {
            ...
            /**
             * Establecer el estado de importación en completado
             */
            $this->importHelper->completed();
        }
    ...
    /**
     * Descargar informe de errores de importación
     */
