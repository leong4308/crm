...
class QuoteController extends Controller
{
    ...
    /**
     * Envíe el presupuesto en PDF al correo electrónico de la persona principal.
     *
     * @param  int  $leadId
     * @param  int  $quoteId
     * @return Response
    ...
    /**
     * Renderice el PDF de la cotización y devuelva el contenido sin procesar.
     */
    ...
    /**
     * Ajusta el contenido árabe y persa.
     */
