...
use Aether\Admin\Http\Controllers\Settings\GroupController;
use Aether\Admin\Http\Controllers\Settings\LocationController;
use Aether\Admin\Http\Controllers\Settings\Marketing\CampaignsController;
use Aether\Admin\Http\Controllers\Settings\Marketing\EventController;
use Aether\Admin\Http\Controllers\Settings\PipelineController;
use Aether\Admin\Http\Controllers\Settings\RoleController;
use Aether\Admin\Http\Controllers\Settings\SettingController;
use Aether\Admin\Http\Controllers\Settings\SourceController;
use Aether\Admin\Http\Controllers\Settings\TagController;
use Aether\Admin\Http\Controllers\Settings\TypeController;
use Aether\Admin\Http\Controllers\Settings\UserController;
use Aether\Admin\Http\Controllers\Settings\Warehouse\ActivityController;
use Aether\Admin\Http\Controllers\Settings\Warehouse\TagController as WarehouseTagController;
use Aether\Admin\Http\Controllers\Settings\Warehouse\WarehouseController;
...
Route::prefix('settings')->group(function () {
    ...
    Route::controller(RoleController::class)->prefix('roles')->group(function () {
        ...
        // Ruta::get('crear', 'crear')->nombre('admin.settings.roles.create');
    ...
    /**
     * Rutas de Ubicación de Almacenes.
     */
    ...
    /**
     * Rutas de plantillas de correo electrónico.
     */
