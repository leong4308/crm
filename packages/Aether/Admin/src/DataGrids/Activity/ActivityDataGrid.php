    ...
    public function prepareQueryBuilder(): Builder
    {
        $queryBuilder = DB::table('activities')
            ->select(
                'activities.*',
                'leads.id as lead_id',
                DB::raw('MAX('.DB::getTablePrefix().'leads.title) as lead_title'),
                DB::raw('MAX('.DB::getTablePrefix().'leads.lead_pipeline_id) as lead_pipeline_id'),
                'users.id as created_by_id',
                DB::raw('MAX('.DB::getTablePrefix().'users.name) as created_by'),
            )
