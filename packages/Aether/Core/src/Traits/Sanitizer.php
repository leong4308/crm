...
/**
 * Característica para desinfectar las cargas SVG para evitar vulnerabilidades de seguridad.
 */
trait Sanitizer
{
    /**
     * Desinfecta un archivo SVG para eliminar contenido potencialmente malicioso.
     */
    ...
    /**
     * Compruebe si el archivo cargado es un SVG según la extensión y el tipo mime.
     */
